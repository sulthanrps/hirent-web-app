        ...
        <MainLayout user={auth.user}>
            ...
            <div className="p-6 md:p-10 font-['Work_Sans'] bg-[#FAFCFE] min-h-screen">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className="text-2xl font-extrabold text-[#0e0e2c]">Add New Product</h1>
                        <p className="text-sm text-[#8C8CA1]">Add a new adventure gear to your rental catalog</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-6">
                        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <div className="relative group overflow-hidden rounded-xl aspect-square bg-gray-50 mb-4 border-2 border-dashed border-gray-200 flex flex-col items-center justify-center p-4 text-center">
                                {imagePreview ? (
                                    <>
                                        <img 
                                            src={imagePreview} 
                                        ...
                                        />
                                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center text-white cursor-pointer rounded-lg">
                                    ...
                                    <div className="flex flex-col items-center justify-center text-gray-400">
                                        <i className="fa-solid fa-cloud-arrow-up text-4xl mb-3 text-gray-300"></i>
                                        <span className="text-xs font-bold text-[#0e0e2c] mb-1">Upload Product Photo</span>
                                        <span className="text-[10px]">Click or drag image here</span>
                                    </div>
                                )}
                                <input 
                                    type="file" 
                            ...
                            <p className="text-[10px] text-[#8C8CA1] leading-relaxed italic">
                                * Wajib diisi. Resolusi rekomendasi: 800x800px. Maksimal ukuran: 2MB (JPG, PNG, WEBP).
                            </p>
                        ...
                        <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input 
                                    ...
                                    placeholder="e.g. Naturehike Cloud Up 2 Person Ultralight Tent"
                                />
                                {errors.name && <span className="text-xs text-red-500 font-semibold">{errors.name}</span>}
                            </div>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {/* Category (Dinamis membaca Database via Controller) */}
                                <div className="flex flex-col gap-2">
                                    ...
                                    {errors.category_id && <span className="text-xs text-red-500 font-semibold">{errors.category_id}</span>}
                                </div>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <input 
                                        ...
                                        placeholder="e.g. 5"
                                    />
                                    {errors.stock && <span className="text-xs text-red-500 font-semibold">{errors.stock}</span>}
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Tuliskan spesifikasi lengkap alat pendakian, ukuran, kapasitas, kelebihan, serta kondisi barang..."
                                ></textarea>
                            ...
                            <div className="flex justify-end gap-4 mt-4 pt-6 border-t border-gray-50">
                                ...
                                >
                                    {processing ? 'Uploading...' : 'Publish Product'}
                                </button>
                            </div>
                        </div>
                    </div>
