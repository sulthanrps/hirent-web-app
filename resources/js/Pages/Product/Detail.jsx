...
export default function Detail({ auth, productId }) {
    ...
    const relatedProducts = Array.from({ length: 4 }, (_, index) => ({
        ...
        price: 25000,
        // Gambar dummy diganti jadi tenda.jpg di sini
    ...
    const handleAddToCart = () => {
        const msg = `✓ ${quantity}x Naturehike Cloud Up 2 (${selectedColor.name}) added to cart!`;
        setToastMessage(msg);
        setShowToast(true);
        setTimeout(() => {
            setShowToast(false);
    ...
    return (
        <MainLayout user={auth.user}>
            ...
            <div className="max-w-[1200px] mx-auto px-[20px] font-['Work_Sans'] text-[#0e0e2c] bg-[#fff]">
                ...
                <main className="flex flex-col lg:flex-row gap-[80px] mb-[50px]">
                    ...
                    <section className="lg:flex-[45%]">
                        ...
                        <div className="mt-[30px]">
                            ...
                            <button 
                                ...
                                className="w-full bg-[#000] hover:bg-[#333] text-[#fff] p-[18px] border-none text-[16px] font-[700] tracking-[1px] cursor-pointer transition-colors duration-300"
                            >
                                ADD TO CART
                            </button>
                        </div>
                    ...
                    <section className="lg:flex-[55%]">
                        ...
                        {/* Penambahan text-justify di sini biar rata kiri-kanan */}
                        <div className="mt-[20px] leading-[1.6] text-[15px] text-justify">
                            ...
                            {/* List juga di justify biar rapi ngikutin paragraf */}
            ...
            {/* TOAST POP-UP */}
            <div 
                className={`fixed bottom-[30px] right-[30px] bg-[#3E5626] text-[#fff] px-[24px] py-[16px] rounded-[8px] shadow-[0_4px_12px_rgba(0,0,0,0.2)] z-[1000] font-[600] transition-all duration-300 flex items-center gap-2 ${
